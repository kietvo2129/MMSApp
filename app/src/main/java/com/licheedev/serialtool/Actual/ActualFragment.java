...
import com.licheedev.serialtool.Actual.Staff.StaffMaster;
import com.licheedev.serialtool.Actual.Staff.StaffMasterAdapter;
import com.licheedev.serialtool.Actual.Staff.VitriLamviecMaster;
import com.licheedev.serialtool.Actual.Staff.VitrilamviecAdapter;
import com.licheedev.serialtool.DMActivity;
import com.licheedev.serialtool.DevicesFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        keyin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.commit();
                //DuLieuWO();
                new docJSONdata2().execute(ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);
            }
        });
    ...
    private void initList() {
        ...
        spinnerdanhsach.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                new docJSONdataAgain().execute(ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);
                Log.d("docJSONdataAgain", ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);
                ...
                new getQC_code().execute(ulrweb+"Lot/get_QC?level=" +
                        level +
                        "&process_no=" +
                        processchon +
                        "&line_no=" +
                ...
                Log.d("getQC_code",ulrweb+"Lot/get_QC?level=" +
                        level +
                        "&process_no=" +
                        processchon +
                        "&line_no=" +
...
//    }
    ...
    private void DuLieuWO() {
        ...
        new docJSONwo().execute(ulrweb+"product/get_fo_no_m_order_facline_day");
        Log.d("docJSONwo", ulrweb+"product/get_fo_no_m_order_facline_day");
    ...
    private void LickspinnerWO() {
        ...
        spinnerWO.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                WOchon = line;
                new docJSONline().execute(ulrweb+"product/get_line_no_m_order_facline_day?fo_no=" + WOchon);
                new docJSONdata_them().execute(ulrweb+"Lot/return_mp_mt_line?wo=" + WOchon);
                Log.d("docJSONline", ulrweb+"product/get_line_no_m_order_facline_day?fo_no=" + WOchon);
                Log.d("docJSONdata_them", ulrweb+"Lot/return_mp_mt_line?wo=" + WOchon);
            }
    ...
    private void LickspinnerLine() {
        ...
        spinnerLine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new docJSONpro().execute(ulrweb+"product/get_process_nm_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon);

                Log.d("docJSONpro",ulrweb+"product/get_process_nm_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon);
            }
    ...
    private void LickspinnerPro() {
        ...
        spinnerPro.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new docJSONdata().execute(ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);

                Log.d("Actual_All", ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);
...
//        dialog.setContentView(R.layout.popup_staff_working);
    ...
    private void LoadData_mold_working() {
        new Data_Mold_working().execute(ulrweb+"product/Getprocess_moldunit_API?process_nm=" + processnamechon+"&fo_no="+WOchon);
        Log.d("Data_Mold_working", ulrweb+"product/Getprocess_moldunit_API?process_nm=" + processnamechon+"&fo_no="+WOchon);
    }
        ...
        bt_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vitriLV[0] == -1) {
                    ...
                    vitriMold = vitriLV[0];
                    url_mode_yes = ulrweb+"product/Createmold_unit_api?process_nm=" +
                            processnamechon  + "&md_no=" + MoldAllMasters.get(vitriMold).getStaffId() + "&remark=" + ""+"&fo_no="+WOchon;
                    new Add_Mold_working().execute(ulrweb+"product/Createmold_unit_api?process_nm=" +
                            processnamechon  + "&md_no=" + MoldAllMasters.get(vitriMold).getStaffId() + "&remark=" + ""+"&fo_no="+WOchon);
                    Log.d("Add_Mold_working", ulrweb+"product/Createmold_unit_api?process_nm=" +
                            processnamechon + "&md_no=" + MoldAllMasters.get(vitriMold).getStaffId() + "&remark=" + ""+"&fo_no="+WOchon);
...
///////////////////
    ...
    private void Data_mold_working_All() {
        ...
        new Data_mold_working_All().execute(ulrweb+"product/MoldMgtData_api");
        Log.d("Data_mold_working_All", ulrweb+"product/MoldMgtData_api");
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("result").equals("1")){
                    dialogxacnhanmode(object.getString("id_update"),object.getString("end"),object.getString("mc_type"));
                }else if (object.getString("result").equals("true")) {
                    Toast.makeText(getContext(), "Done", Toast.LENGTH_SHORT).show();
                    popup_add_Mold.dismiss();
                    LoadData_mold_working();
...
//        dialog.setContentView(R.layout.popup_staff_working);
    ...
    private void LoadData_machine_working() {
        ...
        new Data_Machine_working().execute(ulrweb+"product/Getprocess_machineunit_api?prounit_cd=" + processnamechon+"&fo_no="+WOchon);
        Log.d("Data_Machine_working", ulrweb+"product/Getprocess_machineunit_api?prounit_cd=" + processnamechon+"&fo_no="+WOchon);
    }
        ...
        bt_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vitriLV[0] == -1) {
                    ...
                    url_mc_yes = ulrweb+"product/Createprocessmachine_unit_API?prounit_cd=" +
                            processnamechon + "&mc_type=" + MCAllMasters.get(vitriMC).getStt() + "&mc_no=" + MCAllMasters.get(vitriMC).getStaffId() + "&remark=" + ""+"&fo_no="+WOchon;
                    new Add_MC_working().execute(ulrweb+"product/Createprocessmachine_unit_API?prounit_cd=" +
                            processnamechon + "&mc_type=" + MCAllMasters.get(vitriMC).getStt() + "&mc_no=" + MCAllMasters.get(vitriMC).getStaffId() + "&remark=" + ""+"&fo_no="+WOchon);
                    Log.d("Add_MC_working", ulrweb+"product/Createprocessmachine_unit_API?prounit_cd=" +
                            processnamechon + "&mc_type=" + MCAllMasters.get(vitriMC).getStt() + "&mc_no=" + MCAllMasters.get(vitriMC).getStaffId() + "&remark=" + ""+"&fo_no="+WOchon);
...
///////////////////
    ...
    private void Data_MC_working_All() {
        new Data_MC_working_All().execute(ulrweb+"product/Getmachine_api");
        Log.d("Data_MC_working_All", ulrweb+"product/Getmachine_api");
    }
    ...
    class Add_MC_working extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("result").equals("1")){
                    dialogxacnhanmc(object.getString("id_update"),object.getString("end"));
...
//        dialog.setContentView(R.layout.popup_staff_working);
    ...
    private void LoadData_staff_working() {
        new Data_Staff_working().execute(ulrweb+"product/get_staff?process_nm=" + processnamechon+"&fo_no="+WOchon);
        Log.d("Data_Staff_working", ulrweb+"product/get_staff?process_nm=" + processnamechon+"&fo_no="+WOchon);
    }
        ...
        bt_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vitriLV[0] == -1) {
                    ...
                    new Data_vt_lamviec().execute(ulrweb+"product/get_staff_type");
                    Log.d("Data_vt_lamviec", ulrweb+"product/get_staff_type");
...
///////////////////
    ...
    private void popup_add_vt_lv() {
        ...
        vitrilamviecAdapter.setOnItemClickListener(new VitrilamviecAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                url_addstaff_yes = ulrweb+"product/Createprocess_unitstaff_api?process_nm=" +
                        processnamechon +
                        "&staff_id=" +
                        staffAllMasters.get(vitrilamviec).getStaffId() +
                        "&staff_tp=" +
                        vitriLamviecMasters.get(position).getId()+"&fo_no="+WOchon;
                new Add_Staff_working().execute(ulrweb+"product/Createprocess_unitstaff_api?process_nm=" +
                        processnamechon +
                        "&staff_id=" +
                        staffAllMasters.get(vitrilamviec).getStaffId() +
                        "&staff_tp=" +
                        vitriLamviecMasters.get(position).getId()+"&fo_no="+WOchon);
                Log.d("Add_Staff_working", ulrweb+"product/Createprocess_unitstaff_api?process_nm=" +
                        processnamechon +
                        "&staff_id=" +
                        staffAllMasters.get(vitrilamviec).getStaffId() +
                        "&staff_tp=" +
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("result").equals("1")){
                    ...
                    dialogxacnhan(object.getString("id_update"),object.getString("end"));
    ...
    private void dialogxacnhanmode(String id,String time,String mc_type) {
        ...
        alertDialogadd.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                alertDialogadd.setCancelable(true);
            }
        });

        alertDialogadd.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                add_mode_working_add(id,time,mc_type);
            }
        });
        alertDialogadd.show();
    }
    private void dialogxacnhanmc(String id,String time) {
        AlertDialog.Builder alertDialogadd = new AlertDialog.Builder(getActivity());
        alertDialogadd.setCancelable(false);
    ...
    private void Data_Staff_working_All() {
        new Data_Staff_working_All().execute(ulrweb+"product/get_staff_list_all");
        Log.d("Data_Staff_working_All", ulrweb+"product/get_staff_list_all");
    }
    ...
    public void onResume() {
        ...
        if (WOchon != null && Linechon != null && processchon != null) {
            new docJSONdata().execute(ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);
            Log.d("docJSONData", ulrweb+"product/get_m_order_facline_day?fo_no=" + WOchon + "&line_no=" + Linechon + "&process_no=" + processchon);
        }
    }
    ...
    private void xacnhandelete(int position) {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                new Delete_Staff_working().execute(ulrweb+"product/Delete_api?psid=" + staffMasters.get(position).getStaffNo());
                Log.d("Delete_Staff_working", ulrweb+"product/Delete_api?psid=" + staffMasters.get(position).getStaffNo());
            }
        })
    ...
    private void xacnhandeleteMC(int position) {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                new Delete_Machine_working().execute(ulrweb+"product/Delete_mc_api?pmid=" + machineMasters.get(position).getStaffNo());
                Log.d("Delete_Machine_working", ulrweb+"product/Delete_mc_api?pmid=" + machineMasters.get(position).getStaffNo());
            }
        })
                .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
    ...
    private void xacnhandeleteMold(int position) {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                new Delete_Mole_working().execute(ulrweb+"product/Delete_mold_api?pmid=" + moldMasters.get(position).getStaffNo());
                Log.d("Delete_Mole_working", ulrweb+"product/Delete_mold_api?pmid=" + moldMasters.get(position).getStaffNo());
            }
        })
                .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
