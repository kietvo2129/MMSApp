...
//                        + processchon + "&done_qty=" + numActual + "&refer_qty=" + numDefect);
                ...
                // http://117.0.22.171/product/post_m_order_facline_day?fo_no=W0000000001&line_no=F1LN00001&process_no=P001&prounit_cd=CUT001&prod_sts_cd=A&done_qty=400&refer_qty=600
...
//                new docJSONinsertDefective().execute("http://117.0.22.171/product/post_m_order_facline_day?fo_no=" + WOchon + "&line_no="
        ...
        tvDefectcong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bundle != null) {
                    ...
                    processnamechon = bundle.getString("processnamechon");
...
//                    dialog.show();
//                    spinner = dialog.findViewById(R.id.spinnerlookright);
//                    listViewcolor = dialog.findViewById(R.id.LVcolor);
//                    listView = dialog.findViewById(R.id.listview);
//                    wopopup = dialog.findViewById(R.id.wopopup);
//                    linepopup = dialog.findViewById(R.id.linepopup);
//                    processpopup = dialog.findViewById(R.id.propopup);
//                    cancel = dialog.findViewById(R.id.cancel);
//                    save = dialog.findViewById(R.id.save);
//                    thematerial = dialog.findViewById(R.id.material);
//                    cauhoi1 = dialog.findViewById(R.id.cauhoi1);
//                    cauhoi2 = dialog.findViewById(R.id.cauhoi2);
//                    cauhoi3 = dialog.findViewById(R.id.cauhoi3);
//                    cauhoi4 = dialog.findViewById(R.id.cauhoi4);
//
//                    wopopup.setText(WOchon);
//                    linepopup.setText(Linechon);
//                    processpopup.setText(processchon);
...
//                    lookrightpopup = "";
//                    new docJSONpopup().execute("http://117.0.22.171/product/get_popup_m_order_facline_day?fo_no=" + WOchon + "&line_no="
...
//            dialogwaiting.show();
            ...
            new docJSONbarcodeero().execute("http://117.0.22.171/product/post_barcode_m_order_facline_dayhist?fo_no=" +
                    WOchon +
                    "&line_no=" +
                    Linechon +
                    "&process_no=" +
