package com.licheedev.serialtool.Home;
...
public class HomeFragment extends Fragment {
    ...
    String ApiGet= ulrweb+ "product/get_notice_board";
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Title.length()>0 && Context.length()>0) {
                    switch (kiemtra) {
                        case "A":
                            String apiAdd = ulrweb+ "product/get_notice_board_create?title=" + Title + "&content=" + str + "&reg_id=" + userlogin + "&div_cd=A";
                            new PostNoticeJson().execute(apiAdd);
                            xulyPIvision();
                            dialog.dismiss();
                            break;
                        case "M":
                            new PostNoticeJson().execute(ulrweb+ "product/get_notice_board_create?title=" + Title + "&content=" + str + "&reg_id=" + userlogin + "&div_cd=M");
                            xulyPIvision();
                            dialog.dismiss();
                            break;
...
//                dialog.cancel();
    ...
    private void DeleteRow(final int position) {
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                String apiDelete = ulrweb+ "product/get_notice_board_delete?mno=" + finalMno;
