        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (MaterialCode.length() == 0 && MTbb_no.length() == 0) {
                    //Toast.makeText(LotProductMappingActivity.this, "Insert Material Code", Toast.LENGTH_SHORT).show();
...
//                lotCompositeMasterArrayList.get(position).getUse_yn()
    ...
    private void intext(final String key_location) {
        AlertDialog.Builder builder = new AlertDialog.Builder(LotProductMappingActivity.this);
        builder.setTitle("Material Code");

        View viewInflated = LayoutInflater.from(LotProductMappingActivity.this).inflate(R.layout.text_input_layout, null);
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (result != null) {
            if (result.getContents() == null) {
                Toast.makeText(LotProductMappingActivity.this, "Cancelled", Toast.LENGTH_LONG).show();
            } else {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    String wmmid = jsonObject1.getString("pmno");
                    String mt_no = jsonObject1.getString("mt_no");
                    String mt_lot = jsonObject1.getString("mt_cd");
                    ...
                    lotCompositeMasterArrayList.add(new LotCompositeMaster(wmmid, mt_no, mt_lot, use_yn, mt_cd));
                }
            ...
            lotCompositeMasterAdaptor = new LotCompositeMasterAdaptor(
                    LotProductMappingActivity.this, R.layout.item_product_mapping, lotCompositeMasterArrayList);
