...
import com.licheedev.serialtool.Actual.FragmentKeyin;
...
public class PQC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pqc);
        setTitle("PQC check list");
    ...
    private void LoadQcListAgain() {
        ...
        String url2 = "http://117.0.22.171/product/GetDataFaclineQc?item_vcd=" + Ma_QC_Code + "&olddno=" + olddnochon;
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i = 1; i < jsonArray.length(); i++) {
                    ...
                    String idMqno = object1.getString("mqno");
                    String mq_no = object1.getString("mq_no");
    ...
    private void buildListView() {
        ...
        adaptorCheck = new QcCheckAdapter(PQC.this, R.layout.item_recycler_view_qc_check, qcitem);
    ...
    private void PopUpQcCheckDetail(int position) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(PQC.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);

        View dialogView = LayoutInflater.from(PQC.this).inflate(R.layout.popup_qc_check_qc_detail, null);
        ...
        final String ITEM_MQNO = qcitem.get(position).getIdMqno().replace(",","").replace(".","");

        if (!qcitem.get(position).getDefectqty().trim().equals("null")) {
            DefectQtyMax = Integer.parseInt(qcitem.get(position).getDefectqty().trim().replace(",","").replace(".",""));
        } else {
            DefectQtyMax = 0;
        }
        //anh xa
        ...
        btn_Save_Detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ITEM_CHECK_QTY_S.length() > 1 && ITEM_MQ_HNO_S.length() > 1) {
                    ...
                    String url = "http://117.0.22.171/product/Update_m_facline_qc_value?fqno=" + ITEM_MQNO +
                            "&fqhno=" + ITEM_MQ_HNO_S + "&check_qty=" + ITEM_CHECK_QTY_S;
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getBoolean("result")) {
                    Toast.makeText(PQC.this, "Save success", Toast.LENGTH_SHORT).show();
                    LoadQcListAgain();
                } else {
                    Toast.makeText(PQC.this, "Error!!! Save not success", Toast.LENGTH_SHORT).show();
                }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    String mqhno = object1.getString("fqhno");
    ...
    private void buildQCDetail() {
        ...
        recyclerViewDetail.setLayoutManager(new LinearLayoutManager(PQC.this));
...
//
    ...
    private void inputTextDialog(final int posi) {
        Rect displayRectangle = new Rect();
        Window window = PQC.this.getWindow();
        window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
        final AlertDialog.Builder builder = new AlertDialog.Builder(PQC.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
        builder.setTitle("Qty Value");
        View dialogView = LayoutInflater.from(PQC.this).inflate(R.layout.number_input_layout_ok_cancel, null);
        dialogView.setMinimumWidth((int) (displayRectangle.width() * 1f));
        //dialogView.setMinimumHeight((int)(displayRectangle.height() * 1f));
    ...
    private void CheckButtonPopup() {
        ...
        int checkagain = Integer.parseInt(numActual) - Integer.parseInt(tv_qc_check_qty.getText().toString().replace(",", "").replace(".", ""));
        ...
        View dialogView = LayoutInflater.from(PQC.this).inflate(R.layout.popup_check_qc_check_check, null);
        dialogView.setMinimumWidth((int) (displayRectangle.width() * 1f));
        //dialogView.setMinimumHeight((int)(displayRectangle.height() * 1f));
            ...
            public void onClick(View v) {
                ...
                if (tv_qcheck_checkqty.getText().toString().equals("0")) {
                    ...
                    if (tv_qcheck_defectqty.getText().toString().trim().equals("0")) {
                        ...
                        String url = "http://117.0.22.171/product" /*HostSV*/ +
                                "/Insert_FaclineQc?oldhno=" + olddnochon +
                                "&item_vcd=" + Ma_QC_Code +
        ...
        String url = "http://117.0.22.171/product/Popup_Qc_Check?item_vcd=" + Ma_QC_Code;
...
//        recyclerView.setAdapter(new Adapter(createDummyList(), getContext()));
    ...
    class LoadCheckQc extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                JSONObject object = new JSONObject(s);
                if (object.getString("result").equals("false") || object.getString("result").equals("[]")) {
                    Toast.makeText(PQC.this, "No data", Toast.LENGTH_SHORT).show();
    ...
    private void buildQCMake() {
        ...
        recyclerViewCHECK.setLayoutManager(new LinearLayoutManager(PQC.this));
