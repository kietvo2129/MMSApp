package com.licheedev.serialtool.TotalInspection.TotalInspectionDetail.Visual;
...
import com.licheedev.serialtool.TotalInspection.TotalInspectionDetail.Thinkness.QcCheckThinknessAdapter;
import com.licheedev.serialtool.TotalInspection.TotalInspectionDetail.Thinkness.QcCheckThinknessItem;
import com.licheedev.serialtool.TotalInspection.TotalInspectionDetail.Thinkness.ThinknessActivity;
...
public class VisualActivity extends AppCompatActivity {
    ...
    private void loaddata() {
        new getData().execute("http://ssmes.autonsi.com//TotalInspection/list_data_visual?pno=" + idPLno);
        Log.d("getData", "http://ssmes.autonsi.com//TotalInspection/list_data_visual?pno=" + idPLno);
    }
    ...
    private void buildListView() {
        ...
        listViewCheck.setLayoutManager(new LinearLayoutManager(VisualActivity.this));
    ...
    private void CheckButtonPopup() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(VisualActivity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);

        View dialogView = LayoutInflater.from(VisualActivity.this).inflate(R.layout.popup_check_qc_thickness_check, null);
        ...
        textView_food_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                textView_food_1.setError(null);
                View dialogView = LayoutInflater.from(VisualActivity.this).inflate(R.layout.number_input_layout_ok_cancel, null);
                dialogView.setMinimumWidth((int) (displayRectangle.width() * 1f));
                //dialogView.setMinimumHeight((int)(displayRectangle.height() * 1f));
        ...
        btn_check_save_ck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (numOk == 0 && numDefecty ==0){
                    ...
                    new SaveData_Check().execute("http://ssmes.autonsi.com//TotalInspection/save_thickness_visual?pino=" + idPLno + "&ti_cd=" + "TI0002" + "&ok_qty=" + numOk + "&def_qty=" + numDefecty);
                    Log.d("SaveData_Check", "http://ssmes.autonsi.com//TotalInspection/save_thickness_visual?pino=" + idPLno + "&ti_cd=" + "TI0002" + "&ok_qty=" + numOk + "&def_qty=" + numDefecty);
                    alertDialog.dismiss();
                }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (trave.equals("true")) {
                    Toast.makeText(VisualActivity.this, "Done", Toast.LENGTH_SHORT).show();
