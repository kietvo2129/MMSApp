...
public class VisualActivity extends AppCompatActivity {
    ...
    private void loaddata() {
        new getData().execute("http://117.0.22.171/TotalInspection/list_data_visual?pno=" + idPLno);
        Log.d("getData", "http://117.0.22.171/TotalInspection/list_data_visual?pno=" + idPLno);
    }
        ...
        btn_check_save_ck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (numOk == 0 && numDefecty ==0){
                    ...
                    new SaveData_Check().execute("http://117.0.22.171/TotalInspection/save_thickness_visual?pino=" + idPLno + "&ti_cd=" + "TI0002" + "&ok_qty=" + numOk + "&def_qty=" + numDefecty);
                    Log.d("SaveData_Check", "http://117.0.22.171/TotalInspection/save_thickness_visual?pino=" + idPLno + "&ti_cd=" + "TI0002" + "&ok_qty=" + numOk + "&def_qty=" + numDefecty);
                    alertDialog.dismiss();
                }
