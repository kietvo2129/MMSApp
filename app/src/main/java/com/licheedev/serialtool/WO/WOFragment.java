package com.licheedev.serialtool.WO;
...
public class WOFragment extends Fragment {
    ...
    String API_GET_Work_Order_Master = "http://117.0.22.171/product/post_m_order_facline_info";
...
//                Toast.makeText(MainActivity.this, "" + wo_no, Toast.LENGTH_SHORT).show();
    ...
    private void poup_plan() {
        ...
        new ReadJSONplan().execute("http://117.0.22.171/product/info?fo_no=" +
                wono +
                "&line_no=" +
                lineno);
...
//                goipoup_infomation_wo(i);
    ...
    private void poup_check_stand_by() {
        ...
        new ReadJSONcheckstanby().execute("http://117.0.22.171/product/checkstandby?fo_no=" +
                wono +
                "&line_no=" +
                lineno);

        // Log.d("AAA","http://117.0.22.171/product/GetCheckYN?fo_no=" + wono + "&line_no=" + lineno+ "&process_no=" + planslickProcess + "&olddno=" + OldNoslick + "&work_dt=" + Dateslick);
        //Toast.makeText(this, ""+ "http://117.0.22.171/product/checkstandby?fo_no=" + wono + "&line_no=" + lineno+ "&process_no=" + planslickProcess + "&old_no=" + OldNoslick + "&work_dt=" + Dateslick, Toast.LENGTH_SHORT).show();

        new ReadJSONcheckYESNOTYES().execute("http://117.0.22.171/product/GetCheckYN?fo_no=" + wono + "&line_no=" + lineno +
    ...
    public void check_stand_by_Save_funtion() {
        ...
        new ReadJSONcheck_stand_by_Save().execute("http://117.0.22.171/product/updateCheckYN?material_check_yn=" + meterial_chon + "&machine_check_yn=" + tools_chon + "&staff_check_yn=" + staff_chon + "&olddno=" + OldNoslick);
