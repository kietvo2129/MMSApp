package com.licheedev.serialtool.utils;
...
public class BluetoothUtil {
    ...
    private static final String Innerprinter_Address = "DC:0D:30:41:AF:A9";
    ...
    private static BluetoothDevice getDevice(BluetoothAdapter bluetoothAdapter,String DCMac) {

        BluetoothDevice innerprinter_device = null;
        Set<BluetoothDevice> devices = bluetoothAdapter.getBondedDevices();
        for (BluetoothDevice device : devices) {
            if (device.getAddress().equals(DCMac)) {
     ...
     * @return
     */
    public static boolean connectBlueTooth(Context context, String DCMAc) {
        if (bluetoothSocket == null) {
            ...
            if ((device = getDevice(getBTAdapter(),DCMAc)) == null) {
